...
powiazane: ["[[wiedza/00-fundament/jdk-jre-jvm]]", "[[wiedza/04-build/maven-gleboko]]", "[[wiedza/04-narzedzia/maven-gleboko]]"]
---
...
- **Maven vs Gradle (alternatywa)**: **Gradle** to drugie dominujące narzędzie buildu w JVM. Używa skryptów
  ...
  **incremental build + build cache + daemon**, więc bywa szybszy na dużych/wielomodułowych projektach. Cena:
  ...
  [[wiedza/04-narzedzia/maven-gleboko]].
...
## 🔗 Powiązane
- [[ROADMAP]] · [[wiedza/00-fundament/jdk-jre-jvm]] · [[wiedza/04-build/maven-gleboko]] · [[wiedza/04-narzedzia/maven-gleboko]]
