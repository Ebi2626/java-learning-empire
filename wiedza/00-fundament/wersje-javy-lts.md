...
powiazane: ["[[wiedza/00-fundament/jdk-jre-jvm]]", "[[wiedza/00-fundament/sdkman]]", "[[wiedza/01-jezyk/records]]", "[[wiedza/01-jezyk/virtual-threads]]"]
---
...
- **Records** (`record Point(int x, int y) {}`, J16) — niemutowalne **data carriers**; kompilator generuje konstruktor, `equals`/`hashCode`/`toString`, akcesory. Zob. [[wiedza/01-jezyk/records]].
...
## 🔗 Powiązane
- [[ROADMAP]] · [[wiedza/00-fundament/jdk-jre-jvm]] · [[wiedza/00-fundament/sdkman]] · [[wiedza/01-jezyk/records]] · [[wiedza/01-jezyk/virtual-threads]]
