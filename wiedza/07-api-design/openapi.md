...
powiazane: ["[[wiedza/07-api-design/rest]]", "[[wiedza/07-api-design/dto-mapowanie]]", "[[wiedza/07-api-design/wersjonowanie-api]]"]
---
...
Spec ma `info.version` (wersja API, semantyczna). Zmiany dziel na **backward-compatible** (dodanie opcjonalnego pola, nowego endpointu) i **breaking** (usunięcie pola, zmiana typu, nowe `required`) — te ostatnie wymagają nowej wersji API ([[wiedza/07-api-design/wersjonowanie-api]]). Wersjonuj sam plik spec w repo (git), bo to on jest kontraktem.
...
- **Ujawnianie encji JPA** jako schematów zamiast dedykowanych DTO — wyciek pól, cykle, lazy proxy w spec ([[wiedza/07-api-design/dto-mapowanie]]).
...
## 🔗 Powiązane
- [[ROADMAP]] · [[wiedza/07-api-design/rest]] · [[wiedza/07-api-design/dto-mapowanie]] · [[wiedza/07-api-design/wersjonowanie-api]]
